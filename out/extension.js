...
const myDocumentSemanticTokensProvider_1 = require("./providers/myDocumentSemanticTokensProvider");
function activate(context) {
    const provider = new myDocumentSemanticTokensProvider_1.MyDocumentSemanticTokensProvider();
